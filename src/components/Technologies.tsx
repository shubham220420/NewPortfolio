...
const techGroups = [
  {
    ...
    items: [
      ...
      { name: 'C', icon: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTrPZxw0F-hKbK5AT_Fo3gE8zqDk1_Ex_3vqg&s', docs: 'https://learn.microsoft.com/en-us/cpp/c-language/?view=msvc-170' },
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'Figma', icon: 'https://upload.wikimedia.org/wikipedia/commons/3/33/Figma-logo.svg', docs: 'https://help.figma.com/hc/en-us' },
      { name: 'Framer Motion', icon: 'https://cdn.jsdelivr.net/gh/devicons/devicon/icons/framer/framer-original.svg', docs: 'https://www.framer.com/motion' },
    ],
  },
  {
    label: 'Backend',
  ...
  },
  {
    ...
    items: [
      { name: 'MongoDB', icon: 'https://cdn.jsdelivr.net/gh/devicons/devicon/icons/mongodb/mongodb-original.svg', docs: 'https://www.mongodb.com/docs/' },
       { name : 'Mongoose' , icon: 'https://avatars.githubusercontent.com/u/7558785?s=200&v=4', docs: 'https://mongoosejs.com/docs/' },
